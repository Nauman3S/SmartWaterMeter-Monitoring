...
void setup() //main setup functions
{
    ...
    config.title = "Smart Water Meter"; //set title of webapp
    ...
    Serial.print("MAC: ");
    Serial.println(ss.getMacAddress());//240AC4AFDBDB9C
    ...
    mqttPublish("smart-wm/deviceExists", ss.getMacAddress());
}
...
void loop()
{
    ...
    {
        String v = getGPIOValues();
        mqttPublish("smart-wm/" + String(ss.getMacAddress()) + String("/gallons"), v); //publish data to mqtt broker
